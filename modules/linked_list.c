...
// // Singly linked list source file 
...
// 	// use of dummy node is very significant because it simplifies 
//     // complicated cases [e.x. deletion ]

// 	list->dummy = malloc(sizeof(*list->dummy));
// 	list->dummy->next = NULL;		// empty list , next of dummy is NULL .

// 	// empty list , last node is dummy,too.
